...
enum class TokenType {
    ...
    T_BITWISE_OR_ASSIGN, T_BITWISE_XOR_ASSIGN, T_ARROW, T_DOT, T_SCOPE,
    T_DEREFERENCE, T_ADDRESS_OF, T_SIZEOF, T_TERNARY, T_COLON, T_COMMA,
    
    // Punctuators
    T_SEMICOLON, T_COLON, T_COMMA, T_DOT, T_QUESTION, T_LPAREN, T_RPAREN,
    ...
    T_ENDIF, T_PRAGMA, T_ERROR, T_LINE,
